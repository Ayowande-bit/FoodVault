      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-8 border-b border-slate-800/50 pb-4">
          <button
            ...
            className={`px-6 py-2.5 rounded-xl text-sm font-semibold border-2 transition-all duration-200 ${
              tab === "overview"
              ...
              <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 -mr-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900">
                {filteredPlans.map((plan) => {
                  ...
                  return (
                    <div
                      key={planId}
                      className={`group rounded-2xl border-2 p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/20 ${
                        isActive
                    ...
                    >
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <button
                          ...
                          disabled={loading}
                          className={`px-6 py-3 rounded-xl text-sm font-bold border-2 transition-all duration-200 flex items-center gap-2 shadow-lg ${
                            isActive
